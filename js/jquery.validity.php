...
(function($) {
    ...
    $.validity = {
        ...
        messages:{
            ...
            require:"#{field} <?php echo $traduction->translate("validityErrormsg01"); ?>.",
            // Format validators:
            match:"#{field} <?php echo $traduction->translate("validityErrormsg02"); ?>.",
            integer:"#{field} <?php echo $traduction->translate("validityErrormsg03"); ?>.",
            date:"#{field} <?php echo $traduction->translate("validityErrormsg04"); ?>.",
            email:"#{field} <?php echo $traduction->translate("validityErrormsg05"); ?>.",
            usd:"#{field} <?php echo $traduction->translate("validityErrormsg06"); ?>.",
            url:"#{field} <?php echo $traduction->translate("validityErrormsg07"); ?>.",
            number:"#{field} <?php echo $traduction->translate("validityErrormsg08"); ?>.",
            zip:"#{field} <?php echo $traduction->translate("validityErrormsg09"); ?>.",
            phone:"#{field} <?php echo $traduction->translate("validityErrormsg10"); ?>.",
            guid:"#{field} <?php echo $traduction->translate("validityErrormsg11"); ?>.",
            time24:"#{field} <?php echo $traduction->translate("validityErrormsg12"); ?>.",
            time12:"#{field} <?php echo $traduction->translate("validityErrormsg13"); ?>",

            // Value range messages:
            lessThan:"#{field} <?php echo $traduction->translate("validityErrormsg14"); ?> #{max}.",
            lessThanOrEqualTo:"#{field} <?php echo $traduction->translate("validityErrormsg15"); ?> #{max}.",
            greaterThan:"#{field} <?php echo $traduction->translate("validityErrormsg16"); ?> #{min}.",
            greaterThanOrEqualTo:"#{field} <?php echo $traduction->translate("validityErrormsg17"); ?> #{min}.",
            range:"#{field} <?php echo $traduction->translate("validityErrormsg18"); ?> #{min} - #{max}.",

            // Value length messages:
            tooLong:"#{field} <?php echo $traduction->translate("validityErrormsg19"); ?> #{max} <?php echo $traduction->translate("validityErrormsg32"); ?>.",
            tooShort:"#{field} <?php echo $traduction->translate("validityErrormsg20"); ?> #{min} <?php echo $traduction->translate("validityErrormsg32"); ?>.",

            // Composition validators:
            nonHtml:"#{field} <?php echo $traduction->translate("validityErrormsg21"); ?>.",
            alphabet:"#{field} <?php echo $traduction->translate("validityErrormsg22"); ?>.",

            minCharClass:"#{field} <?php echo $traduction->translate("validityErrormsg23"); ?> #{min} #{charClass} <?php echo $traduction->translate("validityErrormsg32"); ?>.",
            maxCharClass:"#{field} <?php echo $traduction->translate("validityErrormsg24"); ?> #{min} #{charClass} <?php echo $traduction->translate("validityErrormsg32"); ?>.",

            // Aggregate validator messages:
            equal:"<?php echo $traduction->translate("validityErrormsg25"); ?>.",
            distinct:"<?php echo $traduction->translate("validityErrormsg26"); ?>.",
            sum:"<?php echo $traduction->translate("validityErrormsg27"); ?> #{sum}.",
            sumMax:"<?php echo $traduction->translate("validityErrormsg28"); ?> #{max}.",
            sumMin:"<?php echo $traduction->translate("validityErrormsg29"); ?> #{min}.",

            // Radio validator messages:
            radioChecked:"<?php echo $traduction->translate("validityErrormsg30"); ?>.",
        ...
        container:function() {
            document.write(
                "<div class=\"validity-summary-container\">" +
                    "<?php echo $traduction->translate("validityErrormsg31"); ?>" +
                    "<ul></ul>" +
                "</div>"
            );
        }
